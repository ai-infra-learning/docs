...
| 资源 | 类型 | 简介 | 资料 |
|------|------|------|------|
| [Hands-On LLM Serving and Optimization: Hosting LLMs at Scale](https://github.com/cr7258/BooksAndTalks/blob/main/Books/AI/LLM/Hands-On%20LLM%20Serving%20and%20Optimization%20Hosting%20LLMs%20at%20Scale%20%28Chi%20Wang%2C%20Peiheng%20Hu%29.pdf) | 书籍 | Chi Wang 与 Peiheng Hu 编写的 LLM 推理工程实践书，系统讲解 Serving 架构、性能度量与瓶颈分析，覆盖批处理与调度、KV Cache、量化、推测解码、多 GPU 与多节点并行、Prefill-Decode 分离及主流推理框架，并提供 Qwen3-14B 端到端优化案例。 | [官方网站](https://orca3.github.io/llm-model-inference/) · [配套代码](https://github.com/orca3/llm-model-inference) · [O'Reilly](https://www.oreilly.com/library/view/hands-on-llm-serving/9798341621480/) |
