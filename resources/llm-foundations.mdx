...
| [nanoGPT](https://github.com/karpathy/nanoGPT) | 实践项目 | 精简的 PyTorch GPT 训练与微调实现，可从字符级 toy GPT 入门，并进一步复现 GPT-2 124M。项目已停止维护，作者推荐使用后续项目 [nanochat](https://github.com/karpathy/nanochat)。 | [视频](https://www.youtube.com/watch?v=kCc8FmEb1nY) |
