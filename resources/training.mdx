...
- [MAI-Thinking-1: Building a Hill-Climbing Machine](https://microsoft.ai/pdf/mai-thinking-1.pdf) - 微软 MAI-Thinking-1 技术报告，涵盖 MoE 架构、Scaling Ladder、预训练数据、长周期 RL、评测以及大规模训练和推理基础设施。

## 长上下文与测试时训练

- [Test-Time Training Done Right](https://arxiv.org/abs/2505.23884) - 通过 Large Chunk Test-Time Training 提升测试时训练的硬件利用率、状态容量和长上下文扩展能力。
