...
#### 代码：DataParallel vs DistributedDataParallel
...
#### Tree All-Reduce: Double Binary Tree
...
#### NCCL Device API（2.28）：去掉 CPU 中间人
...
### 2. 节点内互联：NVLink、NVSwitch 与 NVLS
...
### 3. 跨节点互联：InfiniBand、RoCE 与 GPUDirect RDMA
