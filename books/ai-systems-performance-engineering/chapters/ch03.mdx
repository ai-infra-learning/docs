...
PART_0=$(echo "sm_partition add $GPU_UUID 7" | sudo nvidia-cuda-mps-control | tail -n 1)
PART_1=$(echo "sm_partition add $GPU_UUID 7" | sudo nvidia-cuda-mps-control | tail -n 1)
PART_2=$(echo "sm_partition add $GPU_UUID 7" | sudo nvidia-cuda-mps-control | tail -n 1)
PART_3=$(echo "sm_partition add $GPU_UUID 6" | sudo nvidia-cuda-mps-control | tail -n 1)
