...
<Accordion title="CUDA 案例（2d_kernel）">
```cpp
// 2d_kernel.cu
...
int main() {
    ...
    // 3) Launch kernel with 2D grid configuration
...
<Accordion title="shared memory / L1 cache">
...
<Accordion title="global memory / HBM">
