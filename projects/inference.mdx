...
| [ovg-project/kvcached](https://github.com/ovg-project/kvcached) | 利用 GPU 虚拟内存解耦 KV Cache 的虚拟地址与物理显存，按实时负载动态分配和回收缓存，使 vLLM、SGLang 服务及其他 GPU 工作负载弹性共享显存。 | [论文](https://arxiv.org/abs/2508.08448) |
