...
| 项目 | 简介 | 参考资料 |
|------|------|----------|
| [google/ax](https://github.com/google/ax) | Google 开源的声明式 Agent 工作负载编排器，通过 Task、Workspace 和 Model 描述任务、工作区与模型配置，并调用 Agent Substrate 管理沙箱 Actor 的创建、挂起与恢复。 | [快速开始](https://github.com/google/ax#quick-start) · [架构设计](https://github.com/google/ax/blob/main/DESIGN.md) |
